...
class DQNCartPoolAgent(DQNAgent):
    def __init__(self, state_size, action_size, buffer_size=10000, batch_size=64, gamma=0.99, lr=1e-3, tau=1e-3,
        ...
        def learn(self, experiences):
            ...
            penalties = cart_positions * 50.0  # Penalize based on distance from center (Cart Position = 0)
            ...
            actions = torch.LongTensor(actions).unsqueeze(
                1)  # Actions need to be long tensors and have an extra dimension
